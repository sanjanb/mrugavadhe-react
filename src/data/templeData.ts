...
export const templeInfo = {
  ...
  historicalSignificance:
    "According to Ramayana, this is where Lord Rama installed a Shivalinga after slaying demon Maricha who came in the form of a golden deer.",
...
export const deities: Deity[] = [
  {
    ...
    description:
      "The main deity of the temple, Lord Mallikarjuna is a form of Lord Shiva. The temple houses a magnificent 4.5 feet tall Shivalinga.",
    image: "/images/mallikarjuna-deity.jpg",
    significance:
      "Installed by Lord Rama himself after slaying demon Maricha. Originally named Malahanikareshwar.",
    offerings: [
      "Milk Abhisheka",
      "Rudrabhisheka",
      "Bilva Leaves",
  ...
  },
  {
    ...
    name: "श्री गणेश",
    description:
      "Lord Ganesha, the remover of obstacles, blesses devotees at the temple entrance.",
    image: "/images/ganesha-deity.jpg",
    significance:
      "Worshipped before beginning any ritual or prayer in the temple.",
...
export const festivals: Festival[] = [
  {
    ...
    description:
      "The most important festival celebrating Lord Shiva. Devotees observe fast and perform night-long prayers.",
  ...
  },
  {
    ...
    description:
      "Festival of lights celebrated with thousands of oil lamps illuminating the temple.",
  ...
  },
  {
    ...
    description:
      "Annual temple festival with grand celebrations and cultural performances.",
...
export const poojas: Pooja[] = [
  {
    ...
    name: "रुद्राभिषेक",
    description:
      "Sacred abhisheka of Lord Shiva with milk, honey, and other holy substances.",
    duration: "45 minutes",
    cost: 501,
  ...
  },
  {
    ...
    name: "विशेष सेवा",
    description:
      "Comprehensive worship including abhisheka, archana, and aarti.",
    duration: "90 minutes",
    cost: 1001,
...
export const newsItems: NewsItem[] = [
  {
    ...
    date: "2025-01-15",
    excerpt:
      "इस वर्ष महाशिवरात्रि के लिए विशेष व्यवस्था और सांस्कृतिक कार्यक्रमों की योजना बनाई गई है।",
    content:
      "मृगावधे मंदिर में महाशिवरात्रि 2025 की तैयारियां पूरे जोश के साथ शुरू हो गई हैं। इस पवित्र अवसर पर भक्तों के लिए विशेष व्यवस्था की जा रही है। रात्रि जागरण, रुद्राभिषेक, और सांस्कृतिक कार्यक्रमों का आयोजन किया जाएगा।",
  ...
  },
  {
    ...
    date: "2025-01-10",
    excerpt:
      "The temple renovation work is progressing well with new facilities for devotees.",
    content:
      "The ongoing renovation of the temple premises is making good progress. New facilities including improved seating arrangements, better lighting, and enhanced safety measures are being implemented for the comfort of devotees.",
  ...
  },
  {
    ...
    date: "2025-01-05",
    excerpt:
      "Devotees can now book poojas and sevas online through our new digital platform.",
    content:
      "To make it easier for devotees to participate in temple rituals, we have launched a new online booking system. Devotees can now book various poojas, sevas, and special events through our website.",
    category: "Technology",
  },
];
...
export const templeImages = {
  ...
  river: ["/images/tunga-river.jpg", "/images/river-view.jpg"],
  general: [
