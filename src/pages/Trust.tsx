    ...
    <div className="page">
      <div className="page-header">
        <div className="container">
          ...
          <p>
            Learn about the governance and administration of our sacred temple
          </p>
        </div>
      </div>
        ...
        <div className="container">
          <div className="grid grid-2">
            <div>
              <h2>Temple Trust</h2>
              <p>
                The Mallikarjuna Temple is managed by a dedicated trust
                comprising devoted individuals committed to preserving the
                temple's sanctity and serving the devotee community.
              </p>
              <p>
                The trust ensures proper maintenance of the temple premises,
                conducts regular poojas and festivals, and manages various
                charitable activities for the benefit of devotees and the local
                community.
              </p>
            ...
            <div>
              <div className="card">
                ...
                <p>
                  The temple is governed by a board of trustees elected from the
                  devotee community.
                </p>
              </div>
              <div className="card mt-2">
                ...
                <p>
                  Experienced administrators ensure smooth daily operations and
                  temple services.
                </p>
              </div>
              <div className="card mt-2">
                ...
                <p>
                  Dedicated volunteers assist in various temple activities and
                  community service.
                </p>
              </div>
            </div>
          ...
          <div className="mt-4">
            ...
            <div className="grid grid-3">
              <div className="card">
                ...
                <p>
                  Regular poojas, festivals, and spiritual ceremonies are
                  conducted according to ancient traditions and customs.
                </p>
              </div>
              <div className="card">
          ...
          <div className="mt-4">
            <div className="card cta-card">
              <h2>Get Involved</h2>
              <p>
                Join our mission to serve the divine and the community. Whether
                through donations, volunteering, or participating in temple
                activities, your contribution makes a difference.
              </p>
